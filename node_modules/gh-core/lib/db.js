...
var _setUpModel = function(sequelize) {
    ...
    Group.belongsTo(AppUser, {'as': 'LockedBy'});

    Group.hasMany(AppUser, {'as': 'Members', 'through': 'Group_Members'});
    AppUser.hasMany(Group, {'as': 'Memberships', 'through': 'Group_Members'});
    ...
    */
    ...
    Event.hasMany(AppUser, {'as': 'Organizers', 'through': 'Event_Organizers'});
    AppUser.hasMany(Event, {'as': 'OrganizedEvents', 'through': 'Event_Organizers'});
