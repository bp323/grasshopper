...
module.exports = function(client) {
     ...
     * @see gh-events/lib/rest.js for more information
     */
    client.event.create = function(displayName, start, end, opts, callback) {
        opts = opts || {};
        var data = {
            'app': opts.app,
     ...
     * @see gh-events/lib/rest.js for more information
     */
    client.event.update = function(id, update, callback) {
        update = update || {};
        var url = '/api/events/' + client.util.encodeURIComponent(id);
        var data = {
            'app': update.app,
            ...
            'notes': update.notes,
            'organiserOther': update.organiserOther,
            'organisers': update.organiserUser,
            'start': start
        };
